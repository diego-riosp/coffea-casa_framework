...
def get_rndm(eta, phi, nL, evtNr, lumiNr, cset, nested=False, rnd_gen="np"):
...
def pt_resol(pt, eta, phi, nL, evtNr, lumiNr, cset, nested=False, low_pt_threshold = 26, rnd_gen="np"):
    """"
